...
rule methylation_extraction_SE_parent_1:
	...
	output:
		...
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p1/CpG_context_1.{sample}_trimmed_bismark_bt2.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p1/CpG_context_1.{sample}_bismark_bt2.deduplicated.txt.gz"),
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p1/CHG_context_1.{sample}_trimmed_bismark_bt2.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p1/CHG_context_1.{sample}_bismark_bt2.deduplicated.txt.gz"),
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p1/CHH_context_1.{sample}_trimmed_bismark_bt2.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p1/CHH_context_1.{sample}_bismark_bt2.deduplicated.txt.gz")
	benchmark:
...
rule methylation_extraction_SE_parent_2:
	...
	output:
		...
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p2/CpG_context_2.{sample}_trimmed_bismark_bt2.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p2/CHG_context_2.{sample}_bismark_bt2.deduplicated.txt.gz"),
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p2/CHG_context_2.{sample}_trimmed_bismark_bt2.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p2/CpG_context_2.{sample}_bismark_bt2.deduplicated.txt.gz"),
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p2/CHH_context_2.{sample}_trimmed_bismark_bt2.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p2/CHH_context_2.{sample}_bismark_bt2.deduplicated.txt.gz")
	benchmark:
...
rule methylation_extraction_SE_allo_1:
	...
	output:
		...
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_se/CpG_context_{sample}_classified1.ref.txt.gz") if config["RUN_READ_SORTING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_se/CpG_context_1.{sample}_trimmed_bismark_bt2.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_se/CpG_context_1.{sample}_bismark_bt2.deduplicated.txt.gz"),
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_se/CHG_context_{sample}_classified1.ref.txt.gz") if config["RUN_READ_SORTING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_se/CHG_context_1.{sample}_trimmed_bismark_bt2.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_se/CHG_context_1.{sample}_bismark_bt2.deduplicated.txt.gz"),
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_se/CHH_context_{sample}_classified1.ref.txt.gz") if config["RUN_READ_SORTING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_se/CHH_context_1.{sample}_trimmed_bismark_bt2.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_se/CHH_context_1.{sample}_bismark_bt2.deduplicated.txt.gz")
	benchmark:
...
rule methylation_extraction_SE_allo_2:
	...
	output:
		...
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_se/CpG_context_{sample}_classified2.ref.txt.gz") if config["RUN_READ_SORTING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_se/CpG_context_2.{sample}_trimmed_bismark_bt2.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_se/CpG_context_2.{sample}_bismark_bt2.deduplicated.txt.gz"),
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_se/CHG_context_{sample}_classified2.ref.txt.gz") if config["RUN_READ_SORTING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_se/CHG_context_2.{sample}_trimmed_bismark_bt2.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_se/CHG_context_2.{sample}_bismark_bt2.deduplicated.txt.gz"),
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_se/CHH_context_{sample}_classified2.ref.txt.gz") if config["RUN_READ_SORTING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_se/CHH_context_2.{sample}_trimmed_bismark_bt2.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_se/CHH_context_2.{sample}_bismark_bt2.deduplicated.txt.gz")
	benchmark:
...
rule methylation_extraction_PE_parent_1:
	...
	output:
		...
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p1/CpG_context_1.{sample}_" + str(config["PAIR_1"]) + "_val_1_bismark_bt2_pe.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p1/CpG_context_1.{sample}_" + str(config["PAIR_1"]) + "_bismark_bt2_pe.deduplicated.txt.gz"),
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p1/CHG_context_1.{sample}_" + str(config["PAIR_1"]) + "_val_1_bismark_bt2_pe.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p1/CHG_context_1.{sample}_" + str(config["PAIR_1"]) + "_bismark_bt2_pe.deduplicated.txt.gz"),
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p1/CHH_context_1.{sample}_" + str(config["PAIR_1"]) + "_val_1_bismark_bt2_pe.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p1/CHH_context_1.{sample}_" + str(config["PAIR_1"]) + "_bismark_bt2_pe.deduplicated.txt.gz")
	benchmark:
...
rule methylation_extraction_PE_parent_2:
	...
	output:
		...
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p2/CpG_context_2.{sample}_" + str(config["PAIR_1"]) + "_val_1_bismark_bt2_pe.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p2/CpG_context_2.{sample}_" + str(config["PAIR_1"]) + "_bismark_bt2_pe.deduplicated.txt.gz"),
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p2/CHG_context_2.{sample}_" + str(config["PAIR_1"]) + "_val_1_bismark_bt2_pe.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p2/CHG_context_2.{sample}_" + str(config["PAIR_1"]) + "_bismark_bt2_pe.deduplicated.txt.gz"),
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p2/CHH_context_2.{sample}_" + str(config["PAIR_1"]) + "_val_1_bismark_bt2_pe.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_p2/CHH_context_2.{sample}_" + str(config["PAIR_1"]) + "_bismark_bt2_pe.deduplicated.txt.gz")
	benchmark:
...
rule methylation_extraction_PE_allo_1:
	...
	output:
		...
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_1/CpG_context_{sample}_classified1.ref.txt.gz") if config["IS_PAIRED"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_1/CpG_context_1.{sample}_" + str(config["PAIR_1"]) + "_val_1_bismark_bt2_pe.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_1/CpG_context_1.{sample}_" + str(config["PAIR_1"]) + "_bismark_bt2_pe.deduplicated.txt.gz"),
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_1/CHG_context_{sample}_classified1.ref.txt.gz") if config["IS_PAIRED"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_1/CHG_context_1.{sample}_" + str(config["PAIR_1"]) + "_val_1_bismark_bt2_pe.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_1/CHG_context_1.{sample}_" + str(config["PAIR_1"]) + "_bismark_bt2_pe.deduplicated.txt.gz"),
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_1/CHH_context_{sample}_classified1.ref.txt.gz") if config["IS_PAIRED"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_1/CHH_context_1.{sample}_" + str(config["PAIR_1"]) + "_val_1_bismark_bt2_pe.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_1/CHH_context_1.{sample}_" + str(config["PAIR_1"]) + "_bismark_bt2_pe.deduplicated.txt.gz")
	benchmark:
...
rule methylation_extraction_PE_allo_2:
	...
	output:
		...
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_2/CpG_context_{sample}_classified2.ref.txt.gz") if config["IS_PAIRED"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_2/CpG_context_2.{sample}_" + str(config["PAIR_1"]) + "_val_1_bismark_bt2_pe.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_2/CpG_context_2.{sample}_" + str(config["PAIR_1"]) + "_bismark_bt2_pe.deduplicated.txt.gz"),
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_2/CHG_context_{sample}_classified2.ref.txt.gz") if config["IS_PAIRED"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_2/CHG_context_2.{sample}_" + str(config["PAIR_1"]) + "_val_1_bismark_bt2_pe.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_2/CHG_context_2.{sample}_" + str(config["PAIR_1"]) + "_bismark_bt2_pe.deduplicated.txt.gz"),
		temp(OUTPUT_DIR + "Bismark/extraction/{sample}_2/CHH_context_{sample}_classified2.ref.txt.gz") if config["IS_PAIRED"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_2/CHH_context_2.{sample}_" + str(config["PAIR_1"]) + "_val_1_bismark_bt2_pe.deduplicated.txt.gz") if config["RUN_TRIMMING"] else temp(OUTPUT_DIR + "Bismark/extraction/{sample}_2/CHH_context_2.{sample}_" + str(config["PAIR_1"]) + "_bismark_bt2_pe.deduplicated.txt.gz")
	benchmark:
