...
rule bismark_alignment_SE_1:
    ...
    output:
        sample=f"{OUTPUT_DIR}Bismark/{{sample}}_1/1.{{sample}}_trimmed_bismark_bt2.bam"
        if config["RUN_TRIMMING"]
        else f"{OUTPUT_DIR}Bismark/{{sample}}_1/1.{{sample}}_bismark_bt2.bam",
        report=f"{OUTPUT_DIR}Bismark/{{sample}}_1/1.{{sample}}_trimmed_bismark_bt2_SE_report.txt"
        if config["RUN_TRIMMING"]
...
rule bismark_alignment_SE_2:
    ...
    output:
        sample=f"{OUTPUT_DIR}Bismark/{{sample}}_2/2.{{sample}}_trimmed_bismark_bt2.bam"
        if config["RUN_TRIMMING"]
        else f"{OUTPUT_DIR}Bismark/{{sample}}_2/2.{{sample}}_bismark_bt2.bam",
        report=f"{OUTPUT_DIR}Bismark/{{sample}}_2/2.{{sample}}_trimmed_bismark_bt2_SE_report.txt"
        if config["RUN_TRIMMING"]
...
rule bismark_alignment_PE_1:
    ...
    output:
        sample=f"{OUTPUT_DIR}Bismark/{{sample}}_1/1.{{sample}}_{str(config['PAIR_1'])}_val_1_bismark_bt2_pe.bam"
        if config["RUN_TRIMMING"]
        else f"{OUTPUT_DIR}Bismark/{{sample}}_1/1.{{sample}}_{str(config['PAIR_1'])}_bismark_bt2_pe.bam",
        report=f"{OUTPUT_DIR}Bismark/{{sample}}_1/1.{{sample}}_{str(config['PAIR_1'])}_val_1_bismark_bt2_PE_report.txt"
        if config["RUN_TRIMMING"]
...
rule bismark_alignment_PE_2:
    ...
    output:
        sample=f"{OUTPUT_DIR}Bismark/{{sample}}_2/2.{{sample}}_{str(config['PAIR_1'])}_val_1_bismark_bt2_pe.bam"
        if config["RUN_TRIMMING"]
        else f"{OUTPUT_DIR}Bismark/{{sample}}_2/2.{{sample}}_{str(config['PAIR_1'])}_bismark_bt2_pe.bam",
        report=f"{OUTPUT_DIR}Bismark/{{sample}}_2/2.{{sample}}_{str(config['PAIR_1'])}_val_1_bismark_bt2_PE_report.txt"
        if config["RUN_TRIMMING"]
