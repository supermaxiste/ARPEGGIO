![Workflow](https://github.com/supermaxiste/ARPEGGIO/actions/workflows/main.yml/badge.svg?event=push) [![Snakemake](https://img.shields.io/badge/snakemake-≥5.20.1-brightgreen.svg?style=flat)](https://snakemake.readthedocs.io) ![GitHub Workflow Status](https://img.shields.io/github/workflow/status/supermaxiste/ARPEGGIO/Lint%20Code%20Base?label=formatting&flat) ![GitHub Workflow Status](https://img.shields.io/github/workflow/status/supermaxiste/ARPEGGIO/Lint%20Code%20Base?label=linting&flat) \
